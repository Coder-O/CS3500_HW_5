...
public final class ThreeTrios {
  ...
  public static void main(String[] args) {
    ...
    PlayerController redController = new PlayerControllerImpl(model, redView, ThreeTriosPlayer.RED);
    PlayerController blueController = new PlayerControllerImpl(model, blueView, ThreeTriosPlayer.BLUE);
